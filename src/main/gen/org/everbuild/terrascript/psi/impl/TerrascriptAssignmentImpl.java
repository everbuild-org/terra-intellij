...
public class TerrascriptAssignmentImpl extends TerrascriptPsiElementImpl implements TerrascriptAssignment {

  public TerrascriptAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
