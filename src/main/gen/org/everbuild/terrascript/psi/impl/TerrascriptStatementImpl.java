...
public class TerrascriptStatementImpl extends ASTWrapperPsiElement implements TerrascriptStatement {
  ...
  @Override
  @Nullable
  public TerrascriptControlFlow getControlFlow() {
    return findChildByClass(TerrascriptControlFlow.class);
  }
