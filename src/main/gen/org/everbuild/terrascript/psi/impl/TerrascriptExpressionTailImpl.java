...
public class TerrascriptExpressionTailImpl extends ASTWrapperPsiElement implements TerrascriptExpressionTail {

  public TerrascriptExpressionTailImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TerrascriptOperator getOperator() {
    return findNotNullChildByClass(TerrascriptOperator.class);
  }
