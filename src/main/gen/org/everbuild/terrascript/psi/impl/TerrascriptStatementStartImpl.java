...
public class TerrascriptStatementStartImpl extends ASTWrapperPsiElement implements TerrascriptStatementStart {

  public TerrascriptStatementStartImpl(@NotNull ASTNode node) {
    super(node);
  }
