...
public class TerrascriptElifBlockImpl extends ASTWrapperPsiElement implements TerrascriptElifBlock {

  public TerrascriptElifBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TerrascriptIfBlock getIfBlock() {
    return findNotNullChildByClass(TerrascriptIfBlock.class);
  }
