...
public class TerrascriptControlFlowImpl extends ASTWrapperPsiElement implements TerrascriptControlFlow {

  public TerrascriptControlFlowImpl(@NotNull ASTNode node) {
    super(node);
  }
